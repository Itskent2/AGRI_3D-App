...
// ── Camera Pins (Standard ESP32-CAM / AI-Thinker) ────────────────────────
// These pins also work for the OV3660 when used as a drop-in replacement.
#define CAM_PWDN 32
#define CAM_RESET -1
#define CAM_XCLK 0
#define CAM_SIOD 26
...
// Camera Orientation (set 1 to flip if image is upside down)
#define CAM_VFLIP 1
