...
class _Esp32LiveFeedState extends State<Esp32LiveFeed> {
  ...
  void _checkAndStartStream() {
    ...
    if (service.isConnected && !_didStartStream) {
      ...
      // CHANGE 8 (VGA - 640x480) to 5 (QVGA - 320x240) for better performance
      service.sendCommand("SET_RES:5");
        ...
        return AspectRatio(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: widget.isDark ? const Color(0xFF374151) : Colors.grey.shade300,
                width: 2,
              ),
              boxShadow: [
                BoxShadow(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Corrupted Frame (${frameBytes.length} bytes)",
